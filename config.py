...
_C.DATA.DATA_PATH = '/home/share/xiuwei/Code/IM/PyCIL-master/data/imagenet100'
# Dataset name
...
_C.MODEL.VSSM.DEPTHS = [ 2, 2, 9, 2 ]                # [2, 2, 9, 2] 
_C.MODEL.VSSM.EMBED_DIM = 128 #96
...
_C.MODEL.VSSM.SSM_FORWARDTYPE =  "v0"#"v2"
_C.MODEL.VSSM.MLP_RATIO = 0.0 #4.0
_C.MODEL.VSSM.MLP_ACT_LAYER = "gelu"
_C.MODEL.VSSM.MLP_DROP_RATE = 0.0
_C.MODEL.VSSM.PATCH_NORM = True
_C.MODEL.VSSM.NORM_LAYER = "ln"
_C.MODEL.VSSM.DOWNSAMPLE = "v1"#"v2"
_C.MODEL.VSSM.PATCHEMBED = "v1"#"v2"
